    ...
    },
    {
      ...
      items: [
        { id: 8, text: "Emergency escape / rescue openings are provided in every sleeping room.",
          ...
          recViolation: "Provide a compliant EERO in each sleeping room (or remove the room's sleeping designation on plans). If the opening was legal when built and maintained, document that for the safe-harbor; otherwise show new/enlarged egress opening on elevations + floor plan with sill height.",
    ...
    },
    {
      ...
      items: [
        ...
        { id: 15, text: "Minimum 8% natural light and 4% ventilation provided based on existing habitable floor area.", trade: "General", safeHarbor: false,
          recViolation: "Provide glazing ≥8% of floor area and openable area ≥4% per habitable room (or mechanical ventilation/artificial light per the safe-harbor era). Tabulate per room on plans.",
    ...
    },
    {
      ...
      items: [
        { id: 33, text: "All wiring — except wiring that conformed with the laws in effect when installed and is currently in good and safe condition and working properly.",
          ...
          recViolation: "Correct unsafe/hazardous wiring. SAFE-HARBOR: wiring that was legal when installed and is currently safe and operational is NOT a violation — do not require a full rewire to current NEC. Scope only the specific hazards; show on electrical plan with a note invoking the 17920.3(d) safe-harbor for retained wiring.",
          recUnconfirmed: "Wiring concealed — open representative areas or note as field-verify; correct only confirmed hazards." },
        { id: 34, text: "All plumbing — except plumbing that conformed when installed (or didn't but is now safe), maintained, and free of cross-connections and siphonage.",
          ...
          recViolation: "Correct unsafe plumbing, cross-connections, and siphonage. SAFE-HARBOR: legal-when-installed, currently-safe plumbing is NOT a violation — scope only the hazards, not a full re-pipe. Note safe-harbor for retained plumbing on plans.",
          recUnconfirmed: "Plumbing concealed — field-verify; correct only confirmed hazards/cross-connections." },
        { id: 35, text: "All mechanical equipment incl. vents — except equipment that conformed when installed (or didn't but is now safe) and maintained.",
          ...
          recViolation: "Correct unsafe mechanical equipment/venting (combustion air, flue, clearances). SAFE-HARBOR: legal-when-installed, currently-safe equipment is NOT a violation. Scope only hazards; note safe-harbor on mechanical plan.",
          recUnconfirmed: "Equipment/venting not fully verified — confirm flue/combustion-air; correct confirmed hazards." },
        ...
        { id: 38, text: "All materials of construction — except those specifically allowed/approved by code and adequately maintained in good and safe condition.",
          ...
          recViolation: "Replace unapproved/unsafe materials with approved, maintained assemblies. SAFE-HARBOR: approved, well-maintained materials need not be replaced. Identify specific materials + replacement on plans.",
          recUnconfirmed: "Identify questionable materials; replace only those confirmed unapproved/unsafe." },
        ...
        { id: 40, text: "Not an unsafe building due to inadequate maintenance, per the latest edition of the California Building Code.",
          ...
          recViolation: "Correct maintenance-related unsafe conditions. NOTE: county confirmed Title 24 (energy) is NOT enforced; the CBC reference here is the life-safety maintenance standard, not a full code upgrade. Scope to genuine unsafe conditions; cite safe-harbor for legal-when-built assemblies.",
          recUnconfirmed: "Evaluate maintenance condition; scope to confirmed unsafe items only." },
        { id: 41, text: "Adequate exit facilities — except those that conformed with the laws when constructed and have been adequately maintained and increased with any added occupant load/alteration/occupancy change.",
          ...
          recViolation: "Provide adequate exits. SAFE-HARBOR: exits legal when built and maintained are NOT a violation absent an occupancy/load change. If altered, show added exits on plans; otherwise document safe-harbor.",
          recUnconfirmed: "Verify exit configuration vs. era built and any alterations; address only true deficiencies." },
        { id: 42, text: "Provided with fire-resistive construction / fire-extinguishing systems required by code — except those that conformed when constructed and have been maintained/improved with any load/alteration/occupancy change.",
          ...
          recViolation: "Address fire-resistive/fire-extinguishing deficiency. SAFE-HARBOR: legal-when-built, maintained construction is NOT a violation absent occupancy/load change. If altered, show required rated assemblies/equipment on plans; else document safe-harbor.",
          recUnconfirmed: "Confirm rated-assembly condition vs. era built; address only deficiencies tied to alterations." },
